		 ...
		 if(!(strcmp(a[i].accountnumber,accountnumber)))
		 {
			 ...
			 { int password,checker;
				 ...
				 else if(checker==1)
				 {
					 while(1)
					 {int choise;
					 printf("Press 1 : Change name\nPress 2 : Change age\nPress 3 : Change gender\nPress 4 : Change phone number\nPress 5 : Change emailid\nPress 6 : Quit\n");
					 scanf("%d",&choise);
					 if(choise==1)
					 {
					 ...
					 else if(choise==2)
					 {
                                             ...
                                             while(1) 
					     {
						     ...
						     scanf("%d",&choise); 
						     if(choise==1)
						              {strcpy(a[i].gender,"Female");break;}
						     else if(choise==2)
						              {strcpy(a[i].gender,"Male");break;}
						     else if(choise==3)
						              {strcpy(a[i].gender,"Transgender");break;}
						     else
							       printf("You Enter invalid choise.....\n");
					    }
                                         }
                                         ...
                                         {
                                                 printf("Enter the phone number to change : ");
                                                 scanf("%ld",&(a[i].phonenumber));
                                                 printf("\n");
                                         }
					 else if(choise==5)
                                         {
                                                 printf("Enter the emailid to change : ");
                                                 scanf("%s",a[i].emailid);
                                                 printf("\n");
                                         }
					 else if(choise==6)
					 ...
					 printf("Press 1 : Continue changing details\nPress 2 : Quit\n");
					 scanf("%d",&choise);
					 if(choise==1)
					 {continue;}
					 else if(choise==2)
					 ...
					 {printf("You have enter invalid choise, so process completed....\n");return;}
					 }
				 }
				 else
			                  i--;
...
{  
	...
	if(num==1)
		...
		return;
	printf("Press 1 : Continue dealing with banking related queries....\nPress 2 : Quit....\n");
	scanf("%d",&num);
	if(num==2)
		break;
	else if(num==1)
